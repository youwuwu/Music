    ...
    internal class FakeDataCreator
    {
        ...
        public static IEnumerable<Album> CreateAlbums()
        {
            yield return new Album()
                         {
                             Title         = "声入人心",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/1.jpg"),
            ...
            yield return new Album()
                         {
                             Title         = "平行世界",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/2.jpg"),
            ...
            yield return new Album()
                         {
                             Title         = "超能力",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/3.jpg"),
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/4.jpg"),
                             PlayCountText = "18.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/5.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/6.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/7.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/8.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/9.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/10.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "当耐人寻味的吉他声再次响起",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/11.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "纯音·水下光年·自然原韵",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/12.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "纯音乐小集「山」主题",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/13.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/14.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "犹如天使的治愈小提琴",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/15.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/16.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/17.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/18.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "哇！通宵无需可乐或咖啡",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/19.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/20.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             ...
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/21.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "下班最来劲",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/22.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "如斯女嗓 骨子里的高冷",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/23.jpg"),
                             PlayCountText = "3.5万",
            ...
            yield return new Album()
                         {
                             Title         = "快节奏 亲密的音乐告白",
                             CoverImageUrl = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Resources/Images/Covers/Rectangle/24.jpg"),
                             PlayCountText = "3.5万",
